      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-xl font-bold text-white">BookTheSlot</h3>
            </div>
            <p className="text-indigo-200 mb-4">We make scheduling simple and efficient for meetings and students.</p>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="https://www.cloudskillsboost.google/" className="text-indigo-200 hover:text-white transition-colors duration-200">
                Google Cloud Labs
                </a>
              </li>
              <li>
                <a href="https://learn.microsoft.com/en-us/training/paths/microsoft-azure-fundamentals-describe-cloud-concepts/" className="text-indigo-200 hover:text-white transition-colors duration-200">
                Azure Fundamentals
                </a>
              </li>
              <li>
        ...
        <div className="border-t border-indigo-700 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-indigo-200 text-sm">
            © {new Date().getFullYear()} BookTheSlot. All rights reserved.
          </p>
          <div className="flex space-x-6 mt-4 md:mt-0">
            <span className="text-indigo-200 hover:text-white transition-colors duration-200 text-sm">
              Made with <span className="text-red-500">❤</span> by Rahul Gujjar
            </span>
          </div>
        </div>
      </div>
